...
export default function DynamicChart (props: DynamicChartProps) {
    ...
    useEffect(() => {
        let myChart: Chart<'line', { x: string; y: number }[], unknown> | null = null;
        ...
        myChart = new Chart<'line', { x: string; y: number }[], unknown>(ctx, {
            options: {
    ...
    }, [props.type, props.garage, props.data]);
